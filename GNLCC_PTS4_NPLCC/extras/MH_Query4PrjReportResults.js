  ...
  "esri/request",
      ...
      return declare([], {
          ...
          RunReport: function (strQuery, gridArray, gridDelivDetail) {
              ...
              arrayQuery.push(["0", strQuery, "Total__Funding_by_Your_LCC", "count", "Total__Funding_by_Your_LCC", "dTotalAllocatedbyLCCSum", '<b>Total NPLCC Funds Allocated: {0}</b>', "currency"]);
              ...
              arrayQuery.push(["6", strQuery, "amount", "sum", "Fund_Year", "dTotalAllocatedbyLCCbyYear", '<b>Total NPLCC Funds Allocated by Year:</b> \n<br>{0} ', "show both"]);
