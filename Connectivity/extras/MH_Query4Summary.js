...
//              arrayQuery.push(["7", strQuery, "InKindamount", "sum", "Contact_Type", "dInKindFundingTypes", '<b>InKind/Match Provider Types:</b> \n<br>&nbsp;&nbsp;&nbsp;&nbsp;{0}     ', "show both-currency", "desc"]);
              ...
              arrayQuery.push(["2", strQuery, "ProjectID", "count", "PrimaryCategory_A", "dEcotypicAreas", '<b>Primary Action Category:</b> \n<br>&nbsp;&nbsp;&nbsp;&nbsp;{0} ', "show both", "asc"]);
              arrayQuery.push(["2", strQuery, "ProjectID", "count", "SecondaryCategory_A", "dStressors", '<b>Secondary Action Category:</b>  \n<br>&nbsp;&nbsp;&nbsp;&nbsp;{0}', "show both", "asc"]);
              arrayQuery.push(["2", strQuery, "ProjectID", "count", "TertiaryCategory_A", "dGoals", '<b>Tertiary Action Category:</b> \n<br>&nbsp;&nbsp;&nbsp;&nbsp;{0} ', "show both", "asc"]);
