  ...
  "extras/PTS_Identify"
      ...
      return declare([], {
          ...
          Phase1: function () {
              ...
              var customExtentAndSR = new esri.geometry.Extent(-13500000, 3500000, -10900000, 5500000, new esri.SpatialReference({ "wkid": 3857 }));
...
//              pPartnershipsAreas = new ArcGISDynamicMapServiceLayer("https://www.sciencebase.gov/arcgis/rest/services/Catalog/55cba773e4b08400b1fddd1f/MapServer", { "opacity": 0.9, id: "PandE_Areas", visible: false });
              ...
              arrayLayers = [pCascadiaPF, pColumbiaPF, pRMPF, pSSPF, pPTS_Projects, plabels1, pBase_LCC, pRefugesLayer,
