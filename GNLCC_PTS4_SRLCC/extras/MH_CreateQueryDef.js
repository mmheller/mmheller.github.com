  ...
  declare, lang, esriRequest
      ...
      return declare([], {   // this will loop through the checkboxes, build a query def for each topic and item selected, and return an array
          ...
          GetMasterAGSMapservicURL: function () {
              return "https://www.sciencebase.gov/arcgis/rest/services/Catalog/5679cdaae4b0da412f4fc2ec/MapServer/";
          },
                          ...
                          if (arrayTable == undefined) {
                              if (strID.indexOf("-ValueRange") > 0) {
                                  ...
                                  if (pform.elements[i].value == "0") {
                                      ...
                                      strQueryString2Add = "(" + strFieldfromCheckBox + " is not NULL) and (" + strFieldfromCheckBox + " >= " + n1stRangeValue + ")";
                                  } else {
                                      ...
                                      strQueryString2Add = "(" + strFieldfromCheckBox + " is not NULL) and ((" + strFieldfromCheckBox + " >= " + n1stRangeValue + ") and (" + strFieldfromCheckBox + " <= " + n2ndRangeValue + "))";
                                  }
