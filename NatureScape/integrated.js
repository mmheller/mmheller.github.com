...
function (Color, esriConfig, HomeButton, Legend, OpacitySlider, PopupTemplate, scaleUtils, InfoTemplate, Map, FeatureLayer, ArcGISTiledMapServiceLayer, 
	ArcGISImageServiceLayer, SimpleRenderer, UniqueValueRenderer, request, PictureMarkerSymbol, SimpleFillSymbol, SimpleLineSymbol, Query, QueryTask,
		...
		return function (layerParms) {
			...
			//tiledLayer = new ArcGISTiledMapServiceLayer("https://gis.fws.gov/arcgis/rest/services/AppLCC/IntegratedModeling/MapServer", 
			...
			console.log(layerParms.tileLayerServiceURL);
			// Load the polygon feature layer for selection.
			//featureLayer = new FeatureLayer("https://gis.fws.gov/arcgis/rest/services/AppLCC/IntegratedModeling/MapServer/1",
			...
			console.log(layerParms.featureLayerServiceURL);
			// Load the data table from the publsihed data layer.
			//dataLayer = new FeatureLayer("https://gis.fws.gov/arcgis/rest/services/AppLCC/IntegratedModeling/MapServer/2",		
			dataLayer = new FeatureLayer(layerParms.dataLayerServiceURL,
				{
					outFields: ["*"]
				}
			);
			console.log(layerParms.dataLayerServiceURL);
