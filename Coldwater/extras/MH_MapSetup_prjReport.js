...
//              dojo.connect(app.mapPrjReport, "onUpdateStart", showLoading);
              ...
              var legendLayers = [];
              pDetectionsLayer = new FeatureLayer(app.strTheme1_URL + "0", { "opacity": 0.7, mode: FeatureLayer.MODE_ONDEMAND, id: 0, visible: true });
              ...
              pReceiversLayer = new FeatureLayer(strBase_URL + "11", { mode: FeatureLayer.MODE_ONDEMAND, id: "LCC", outFields: [strlabelField1], visible: true });
              ...
              arrayLayers = [pDetectionsLayer, plabels1, pReceiversLayer];
          ...
          QueryZoom: function (strQuery) {
              ...
              var pQueryT1 = new esri.tasks.QueryTask(pDetectionsLayer.url);
              var pQuery1 = new esri.tasks.Query();

              pQuery1.returnGeometry = true;
              pQuery1.outFields = ["objectid, ProjectID"];

              var strQuery1 = pDetectionsLayer.getDefinitionExpression();
