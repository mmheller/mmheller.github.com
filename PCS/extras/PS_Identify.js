    ...
    return declare([], {
        ...
        executeQueries: function (pEvt, strSingleLayerName, iSingleObjectID, dblX, dblY) {
            ...
            if (pEvt != null) {
                ...
                pSR = pEvt.mapPoint.spatialReference;
                ...
                padding = 3 * pxWidth;
                //                pSP = this.app.pPS_Identify.pEvt.screenPoint;
            } else {
                pSR = app.map.SpatialReference;
                var pMP = new esri.geometry.Point(dblX, dblY);
            ...
            qGeom = new esri.geometry.Extent({ "xmin": dblX - padding, "ymin": dblY - padding, "xmax": dblX + padding, "ymax": dblY + padding, "spatialReference": pSR });
            ...
            if (resultFeatures.length > 0) {
                ...
                if (strStat_Type == "nostat") {  // code handles features and displaying features in the identify window
                    ...
                    if (strConcat == "countExceedance") { this.m_ExceedCount = iStatValue; }
                        ...
                        this.app.pPS_Identify.strFeatureContent += "<br />      " + strStat_Type + " = " + iStatValue; //this.app.pPS_Identify.strFeatureContent += "<br />      " + strStat_Type + " = " + iStatValue + " " + strOnStatisticField;
                    }
                }
                ...
                this.app.mCp2 = new dijit.layout.ContentPane({ id: "cp2", title: "Exceedance Pie Chart" });
                this.app.mCp3 = new dijit.layout.ContentPane({ id: "cp3", title: "Measurement Records", content: tab3Content });
        ...
        returnEvents: function (results) {
            ...
            if (this.m_dblY != null) {
                var CK_ASZ = new CK_AutoCompleteSearchAndZoom({ pMap: app.map, dblExpandNum: 2, divTag4Results: document.getElementById("loc"), strSearchField: "SID" }); // instantiate the class
